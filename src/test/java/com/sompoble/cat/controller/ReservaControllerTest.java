...
public class ReservaControllerTest {
    ...
    public void testCreateReservaCamposObligatoriosFaltantes() throws Exception {
        ...
        Servicio servicioParaTest = new Servicio();
        servicioParaTest.setIdServicio(1L);
        servicioParaTest.setEmpresa(empresa); 
        when(servicioService.obtenerPorId(1L)).thenReturn(servicioParaTest);
    ...
    public void testCreateReservaServicioSinHorarios() throws Exception {
        ...
        servicioSinHorarios.setEmpresa(empresa);
