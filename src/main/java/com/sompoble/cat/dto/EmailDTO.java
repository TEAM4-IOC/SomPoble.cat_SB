 ...
 *
 * Se utiliza en el controlador
 * {@link com.sompoble.cat.controller.EmailController} para recibir datos desde
 * el cliente de forma segura y validada.
 */
public class EmailDTO {

    /**
     * Dirección de correo electrónico del destinatario. Debe tener un formato
    ...
    /**
     * Asunto del correo electrónico. No puede estar vacío.
     */
    @NotBlank(message = "El asunto no puede estar vacío")
    private String asunto;

    /**
     * Cuerpo del mensaje del correo electrónico. No puede estar vacío.
     */
