...
public class ClienteController {
     ...
     *
     * @return ResponseEntity con una lista de clientes si existen, o una
     * excepción si no hay clientes.
     * @throws ResourceNotFoundException si no se encuentran clientes en la base
     * de datos.
     */
    @GetMapping
     ...
     * @return ResponseEntity con el cliente si se encuentra, o una excepción si
     * no se encuentra.
     * @throws ResourceNotFoundException si el cliente con el DNI especificado
     * no existe.
     */
    @GetMapping("/{dni}")
     ...
     *
     * @param cliente Objeto cliente que contiene los datos necesarios para
     * crear el cliente.
     * @return ResponseEntity indicando que el cliente ha sido creado.
     * @throws BadRequestException si el DNI o el email ya existen en la base de
     * datos.
     */
    @PostMapping
     ...
     * @return ResponseEntity indicando que el cliente ha sido actualizado
     * correctamente.
     * @throws ResourceNotFoundException si el cliente con el DNI especificado
     * no existe.
     */
     ...
     * @return ResponseEntity indicando que el cliente ha sido eliminado
     * correctamente.
     * @throws ResourceNotFoundException si el cliente con el DNI especificado
     * no existe.
     */
