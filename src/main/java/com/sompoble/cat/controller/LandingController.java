...
/**
 * Controlador REST para la página de inicio (landing page).
 * Proporciona un endpoint optimizado que combina datos de empresas y sus servicios
 * para reducir el número de llamadas API necesarias desde el frontend.
 * 
...
public class LandingController {
    ...
    /**
     * Obtiene datos combinados de empresas y sus servicios para la página de inicio.
     * Este método reduce múltiples llamadas API en una sola, mejorando el rendimiento
     * del frontend al cargar la página de inicio.
     * 
     * @return ResponseEntity con una lista de empresas y sus servicios en formato DTO optimizado
