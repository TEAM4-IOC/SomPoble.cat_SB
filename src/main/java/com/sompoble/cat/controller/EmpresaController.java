...
public class EmpresaController {
    ...
    public ResponseEntity<?> update(@PathVariable String identificadorFiscal, @RequestBody Map<String, Object> updates) {
        try{
            ...
            if (value != null) {
                switch (key) {
                    case "identificadorFiscal" -> existingEmpresa.setIdentificadorFiscal(value.toString());
                    case "nombre" -> existingEmpresa.setNombre(value.toString());
                    case "actividad" -> existingEmpresa.setActividad(value.toString());
                    case "direccion" -> existingEmpresa.setDireccion(value.toString());
                    case "email" -> existingEmpresa.setEmail(value.toString());
                    case "telefono" -> existingEmpresa.setTelefono(value.toString());
                }
            }
        });
