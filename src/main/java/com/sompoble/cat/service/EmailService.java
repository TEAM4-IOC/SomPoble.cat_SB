...
public interface EmailService {
    ...
    /**
     * Envía un correo electrónico basado en la información proporcionada en el DTO.
     *
     * @param email el objeto {@link EmailDTO} que contiene los detalles del correo a enviar
     * @throws MessagingException si ocurre un error al enviar el correo
     */
    void sendMail(EmailDTO email) throws MessagingException;

    /**
     * Envía recordatorios automáticos por correo electrónico según la programación definida.
     */
    void sendAutomaticReminders();

    /**
     * Envía un correo electrónico de prueba en texto plano para verificar el servicio de correo.
     */
