 ...
 * horarios, así como búsquedas y filtros por diferentes criterios como empresa,
 * días laborables, rangos de horas, etc.
 * </p>
 */
public interface HorarioService {
     ...
     * @return Un {@link Optional} que contiene el horario si existe, o vacío si
     * no se encuentra.
     */
    ...
    /**
     * Busca horarios que contengan un día laboral específico, sin distinguir
     ...
     * @return Lista de horarios con hora de inicio dentro del rango
     * especificado.
     */
    ...
    /**
     * Busca horarios de una empresa específica que incluyan un día laboral
     * determinado.
     *
     * @param idEmpresa Identificador de la empresa.
     * @param dia Día de la semana a buscar.
    ...
    /**
     * Obtiene todos los horarios ordenados por hora de inicio de forma
     * ascendente.
     *
    ...
    /**
     * Busca horarios de una empresa específica que estén comprendidos entre dos
     * horas determinadas.
     *
     * @param idEmpresa Identificador de la empresa.
    ...
    /**
     * Busca un horario específico para una empresa, en un día y con horas de
     * inicio y fin exactas.
     *
     * @param idEmpresa Identificador de la empresa.
     * @param dia Día de la semana.
     * @param inicio Hora exacta de inicio.
     * @param fin Hora exacta de fin.
     * @return El horario que cumple con todos los criterios, o null si no
     * existe.
     */
    ...
    /**
     * Busca horarios cuya hora de inicio esté en un rango y cuya hora de fin
     * esté en otro rango.
     *
