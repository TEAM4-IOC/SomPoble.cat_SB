 ...
 * <p>
 * Esta interfaz proporciona métodos para obtener información combinada
 * de servicios y sus horarios asociados, facilitando la consulta
 * y manipulación de estas relaciones.
 * </p>
 */
public interface ServicioHorarioService {
    
    /**
     * Obtiene todos los servicios con sus horarios asociados para una empresa específica.
     *
     * @param identificadorFiscal Identificador fiscal de la empresa.
     * @return Lista de DTOs que contienen información combinada de servicios y horarios.
     */
     ...
     * @return Lista de DTOs que contienen información de los servicios que coinciden
     *         con los criterios de búsqueda y sus horarios.
     */
    List<ServicioHorarioDTO> buscarPorNombreYServicio(
        String nombreServicio, String diaLaborable);
    
    /**
     * Crea un DTO combinado a partir de los identificadores de un servicio y un horario.
     *
