 ...
 * Esta excepción se utiliza para indicar que se ha intentado acceder o manipular
 * un evento que no existe en el sistema.
 * <p>
...
public class EventoNoEncontradoException extends RuntimeException {
    ...
    /**
     * Construye una nueva excepción de evento no encontrado con el ID especificado.
     * 
