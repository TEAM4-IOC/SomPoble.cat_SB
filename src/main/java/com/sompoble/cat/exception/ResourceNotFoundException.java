...
/**
 * Excepción personalizada que representa situaciones donde un recurso solicitado
 * no puede ser encontrado en el sistema.
 * <p>
 * Esta excepción se lanza cuando se intenta acceder a recursos como entidades,
 * archivos o datos que no existen o no están disponibles en el momento de la solicitud.
 * </p>
 * <p>
...
public class ResourceNotFoundException extends RuntimeException {
     ...
     *
     * @param message el mensaje detallado que explica qué recurso no se encontró.
