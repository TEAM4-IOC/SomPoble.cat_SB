 ...
 * <p>
 * Un servicio tiene un nombre, descripción, duración, precio, límite de
 * reservas, una empresa a la que pertenece, y tiene una lista de reservas y
 * horarios asociados.
 * </p>
 */
@Entity
...
public class Servicio implements Serializable {
    ...
    /**
     * Nombre del servicio. Este campo es obligatorio y no puede exceder los 100
     * caracteres.
     */
    ...
    /**
     * Descripción del servicio. Este campo es obligatorio.
     */
    @Column(name = "DESCRIPCION", nullable = false)
    @NotNull
    private String descripcion;
    /**
     * Duración del servicio en minutos. Este campo es obligatorio.
     */
    @Column(name = "DURACION", nullable = false)
    @NotNull
    private int duracion;
    /**
     * Precio del servicio. Este campo es obligatorio.
     */
    @Column(name = "PRECIO", nullable = false)
    @NotNull
    private float precio;
    /**
     * Límite de reservas permitidas para el servicio. Este campo es
     * obligatorio.
     */
    ...
    /**
     * La empresa a la que pertenece este servicio. Este campo es obligatorio.
     */
    @ManyToOne
    ...
    /**
     * Fecha de alta del servicio. Se genera automáticamente al crear el
     * servicio.
     */
    @CreationTimestamp
    ...
    /**
     * Fecha de última modificación del servicio. Se actualiza automáticamente
    ...
    /**
     * Lista de reservas asociadas a este servicio. Este campo no puede ser
     * nulo.
     */
    ...
    /**
     * Constructor con parámetros para inicializar un servicio con los datos
     * proporcionados.
     *
