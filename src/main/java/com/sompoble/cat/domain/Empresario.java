...
/**
 * Entidad que representa a un Empresario en el sistema. Hereda de
 * {@link Persona} y puede tener asociadas múltiples empresas y notificaciones.
 */
@Entity
...
public class Empresario extends Persona {
    ...
    /**
     * Lista de empresas asociadas al empresario. Relación uno a muchos con la
     * entidad {@link Empresa}.
     */
    @OneToMany(mappedBy = "empresario")
    @JsonManagedReference
    private List<Empresa> empresas;
    /**
     * Lista de notificaciones recibidas por el empresario. Relación uno a
     * muchos con la entidad {@link Notificacion}.
     */
    @OneToMany(mappedBy = "empresario")
