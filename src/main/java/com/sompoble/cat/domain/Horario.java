 ...
 * <p>
 * Esta clase contiene la información de los horarios de trabajo de una empresa
 * para un servicio específico. Además, registra los días laborables, las horas
 * de inicio y fin, y las fechas de alta y modificación.
 * </p>
 */
@Entity
@Table(name = "HORARIO")
public class Horario implements Serializable {
    ...
    /**
     * Días de la semana en los que se realiza el servicio (por ejemplo, "Lunes
     * a Viernes").
     */
    ...
    /**
     * Fecha en la que se creó el horario. Este campo se actualiza
     * automáticamente al crear una nueva instancia.
     */
    @CreationTimestamp
    @Column(name = "FECHA_ALTA", updatable = false, nullable = false)
    private LocalDateTime fechaAlta;
    /**
     * Fecha en la que se realizó la última modificación del horario. Este campo
     * se actualiza automáticamente cada vez que se actualiza el horario.
     */
    @UpdateTimestamp
    @Column(name = "FECHA_MODIFICACION", nullable = false)
    private LocalDateTime fechaModificacion;
    /**
     * Empresa asociada a este horario. Relación muchos a uno con la entidad
     * {@link Empresa}.
     */
    @ManyToOne
    ...
    /**
     * Servicio asociado a este horario. Relación muchos a uno con la entidad
     * {@link Servicio}.
     */
    @ManyToOne
