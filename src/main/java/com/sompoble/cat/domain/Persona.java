 ...
 * <p>
 * La clase Persona es la clase base de la cual pueden heredar otros tipos de
 * personas como clientes o empresarios.
 * </p>
 */
@Entity
...
public class Persona implements Serializable {
    ...
    /**
     * Número de identificación de la persona (DNI). Este campo es obligatorio y
     * debe tener una longitud de exactamente 9 caracteres.
     */
    ...
    private String dni;
    /**
     * Nombre de la persona. Este campo es obligatorio y no puede exceder los
     * 100 caracteres.
     */
    ...
    /**
     * Apellidos de la persona. Este campo es obligatorio y no puede exceder los
     * 100 caracteres.
     */
    ...
    /**
     * Correo electrónico de la persona. Este campo es obligatorio y no puede
    ...
    /**
     * Teléfono de la persona. Este campo es obligatorio y no puede exceder los
     * 20 caracteres.
     */
    ...
    /**
     * Contraseña de la persona, la cual está cifrada. Este campo es obligatorio
     * y no puede exceder los 255 caracteres.
     */
    ...
    private String pass;
    /**
     * Fecha en la que se registró la persona. Este campo es generado
     * automáticamente al momento de crear la persona.
     */
    @Column(name = "FECHA_ALTA", updatable = false, nullable = false, columnDefinition = "DATETIME")
    @CreationTimestamp
    private LocalDateTime fechaAlta;
    /**
     * Fecha en la que se modificó por última vez la persona. Este campo es
     * generado automáticamente cada vez que se actualiza la persona.
     */
    @Column(name = "FECHA_MODIFICACION", nullable = false, columnDefinition = "DATETIME")
    @UpdateTimestamp
    private LocalDateTime fechaModificacion;
    /**
     * Instancia del codificador de contraseñas (BCryptPasswordEncoder) para
    ...
    /**
     * Constructor con parámetros para inicializar una persona con los datos
     * proporcionados.
     *
    ...
    /**
     * Establece la contraseña de la persona. La contraseña será cifrada antes
     * de ser guardada.
     *
