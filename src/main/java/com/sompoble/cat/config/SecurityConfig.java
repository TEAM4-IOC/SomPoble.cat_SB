 ...
 * <p>
 * Esta clase define cómo se gestionan las solicitudes HTTP en términos de seguridad,
 * incluyendo la desactivación del CSRF y la codificación de contraseñas.
 * </p>
 */
@Configuration
public class SecurityConfig {
     ...
     * <p>
     * Actualmente se permite el acceso a todas las rutas y se desactiva la protección CSRF.
     * Esta configuración es útil durante el desarrollo, pero debe ser revisada para producción.
     * </p>
     *
     ...
     * <p>
     * Este bean se utiliza para cifrar las contraseñas de los usuarios antes de almacenarlas
     * en la base de datos.
     * </p>
     *
